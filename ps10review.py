...
class Programming_Student(Student):
    def __init__(this_Student,name, years_at_umich = 100, number_programs_written = 0):
        Student.__init__(this_Student,name, years_at_umich )
        this_Student.number_programs_written = number_programs_written

    def write_programs(this_Student, progs = 1):
        this_Student.number_programs_written+= progs
        return this_Student.number_programs_written
...
class Post():
    ...
    def emo_score(self):
        ...
        for word in self.message.split():
            if word in neg_ws:
                neg_lst.append(word)
        return len(pos_lst) - len(neg_lst)      
...
access_token = "EAACEdEose0cBAMY08dIQDlCkZBEZC3YqfAvz5cyq9ZCNQRmXrXzKTn1dDqcjgUXyI7efKe6IyyxnanFW0ZAoUDafbm7lUEctm0JaBtDvElNfiZCUmaJJDgeVDPgZBrljZBSp6XtLmymhwWmCbSWuZAbLLggQxKwISXGtVAji5DspxgZDZD"
if access_token == None:
    access_token = raw_input("\nCopy and paste token from https://developers.facebook.com/tools/explorer\n>  ")

baseurl = "https://graph.facebook.com/v2.3/10207303196924913/feed"
