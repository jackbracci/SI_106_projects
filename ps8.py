...
try:
    ...
    airport_response=requests.get(new_url, url_parameters)
...
#   airport_code, status_reason, current_temp, recent_update
...
try:
    ...
    test.testEqual(airport_code,u"DTW","testing p3 airport name")
...
for each in your_favs:
	try:
		print extract_aitport_dada(each)
	except:
		print each + "is not real"
