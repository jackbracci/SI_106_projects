...
class Ball(GameObject):
    ...
    default_velocity = 5 #Number of pixels the ball should move per game cycle
...
class ForwardPaddle(Paddle):
    def deflect_ball(self,ball,side_hit):
        if self.player ==1 and side_hit =="LEFT":
            pass
        elif self.player ==1 and side_hit == "RIGHT":
            pass
        else:
            paddle.deflect_ball(self,side_hit)
