...
car_method_description = "when you push down the gas pedal "
...
flickr_response = flickrREST(cache_fname = "flickr_response.txt", extra_params = {'tags':"sunset", 'per_page': 50 })
...
x = x.read()
flickr_diction = json.loads(x[14:-1])
...
photo_ids_list = []
for dictionary in flickr_diction['photos']['photos']:
